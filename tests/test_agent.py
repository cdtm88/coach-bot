...
def test_every_tool_has_a_schema() -> None:
    # P10 added set_break; get_plan reads the plan back; P16 added
    # log_capability_gap, which is TRUST-05's named way out rather than a
    # retrieval tool.
    assert len(tools.SCHEMAS) == 11
